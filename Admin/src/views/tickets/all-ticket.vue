                  ...
                  <BRow class="mb-2">
                     ...
                     <BCol sm="8">
                        <div class="text-sm-end">
                           ...
                           <BButton @click="fetchTickets('Résolu')" variant="success" class="btn-rounded mb-2 me-2">
                              Résolu
                           </BButton>
                     ...
                     <BTableSimple class="table-centered table-nowrap align-middle">
                        ...
                        <BTbody>
                           <BTr v-for="(ticket, index) in tickets" :key="index">
                              ...
                              <BTd>
                                 <BButton variant="primary" class="btn-sm btn-rounded" @click="viewTicket(ticket.id)">
                                    Voir
                                 </BButton>
                              </BTd>
                              <BTd>
                                 <BDropdown class="card-drop" variant="white" right toggle-class="p-0"
                                    ...
                                    <BDropdownItem @click="openAssignModal(ticket.id)"
                                       v-if="!['En cours', 'Résolu', 'Fermé'].includes(ticket.status)">
               ...
               <div class="mb-3">
                  <BFormGroup label="Priorite">
                     <BFormSelect v-model="editTicket.priorite.id" class="form-select">
                        <BFormSelectOption v-for="priorite in priorites" :key="priorite.id" :value="priorite.id">{{
