            ...
            <BCard no-body>
               <BCardBody>
                  ...
                  <BForm @submit.prevent="createUser">
                     <BFormGroup class="mb-3" label="Nom" label-for="horizontal-firstname-input" label-cols-sm="3">
                        <BFormInput id="horizontal-firstname-input" v-model="user.name" type="text"
                           placeholder="Enter the name" :class="{
                                    'is-invalid': submitted && v$.name.$error,
                                }">
                        </BFormInput>
                        <div v-for="(item, index) in v$.name.$errors" :key="index" class="invalid-feedback">
                     ...
                     <BFormGroup class="mb-4" label="Role" label-for="horizontal-role-input" label-cols-sm="3">
                        ...
                        <div v-for="(item, index) in v$.role.$errors" :key="index" class="invalid-feedback">
                                    <span v-if="item.$message">{{ item.$message }}</span>
                                </div>
